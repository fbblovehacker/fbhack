...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              NYI NYI. ^_^")
    runntxt(WW+"   ..................  ANDA MENCOBA MENGHUBUNGI")
    runntxt(WW+"     ....       MR.NYINYI")
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: MR.NYI NYI             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |        TEAM : MYANMAR CYBER ErRoR SyStEm            |"
...
def runn_noobs():
         ...
         lop = GG+"""
                   ...
                   _______ _____.___.___   _______ _____.___.___ 
 \      \\__  |   |   |  \      \\__  |   |   |
 /   |   \/   |   |   |  /   |   \/   |   |   |
/    |    \____   |   | /    |    \____   |   |
\____|__  / ______|___| \____|__  / ______|___|
        \/\/                    \/\/            \033[91;1m
